...
<center><h2>友情链接编辑<a href="{{url('/link/index')}}" style="float:right" class="btn btn-default">列表</a></h2></center><br>
...
<form action="{{url('/link/update',$res->link_id)}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
@csrf
	<div class="form-group">
		<label for="firstname" class="col-sm-2 control-label">网站名称</label>
		<div class="col-sm-8">
			<input type="text" class="form-control" name="link_name" value="{{$res->link_name}}" id="firstname" 
				   placeholder="请输入网站名称">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="link_url" value="{{$res->link_url}}" id="lastname" 
				   placeholder="请输入网站网址">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="radio" name="link_type" value="1" {{$res->link_type=="1" ? "checked" : ""}}>LOGO链接  
			<input type="radio" name="link_type" value="2" {{$res->link_type=="2" ? "checked" : ""}}>文字链接 
		</div>
	</div>
	<div class="form-group">
		...
		@if($res->link_logo)
		    <img src="{{env('ADMINLOGO_URL')}}{{$res->link_logo}}" width="45px" height="45px">
        @endif
    </div>
	<div class="form-group">
		<label for="lastname" class="col-sm-2 control-label">网站联系人</label>
		<div class="col-sm-8">
			<input type="text" class="form-control" name="link_man" value="{{$res->link_man}}" id="lastname" 
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<textarea type="text" class="form-control" name="link_desc" id="lastname" 
				   placeholder="请输入网站介绍">{{$res->link_desc}}</textarea>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
		    <input type="radio" name="link_show" value="1" {{$res->link_show=="1" ? "checked" : ""}}>是  
			<input type="radio" name="link_show" value="2" {{$res->link_show=="2" ? "checked" : ""}}>否 	   
		</div>
	</div>
	<div class="form-group">
